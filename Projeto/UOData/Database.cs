...
namespace UOData
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="euo")]
    ...
    partial void OnyoungdurationChanged();
		...
		[Column(Storage="_passwd", DbType="NVarChar(50)")]
		...
		[Column(Storage="_accesslevel", DbType="NChar(6)")]
		...
		[Column(Storage="_totalgametime", DbType="DateTime")]
		...
		[Column(Storage="_youngduration", DbType="DateTime")]
		...
		[Association(Name="account_player", Storage="_players", ThisKey="id", OtherKey="account_id")]
    ...
    partial void Onplayer_idChanged();
		...
		[Column(Storage="_mobile_id", DbType="Int")]
		...
		[Column(Storage="_player_id", DbType="Int")]
		...
		[Association(Name="mobile_vendor", Storage="_mobile", ThisKey="mobile_id", OtherKey="id", IsForeignKey=true)]
		...
		[Association(Name="player_vendor", Storage="_player", ThisKey="player_id", OtherKey="id", IsForeignKey=true)]
    ...
    partial void OnmanaChanged();
		...
		[Column(Name="int", Storage="_int", DbType="Float")]
		...
		[Column(Storage="_dex", DbType="Float")]
		...
		[Column(Storage="_str", DbType="Float")]
		...
		[Column(Storage="_hitpoint", DbType="Int")]
		...
		[Column(Storage="_mana", DbType="Int")]
		...
		[Association(Name="attributereq_itemtype", Storage="_itemtypes", ThisKey="id", OtherKey="attributereq_id")]
		...
		[Association(Name="attributereq_spell", Storage="_spells", ThisKey="id", OtherKey="attributereq_id")]
    ...
    partial void OnmanaChanged();
		...
		[Column(Storage="_hitpoints", DbType="Int")]
		...
		[Association(Name="attribute_mobile", Storage="_mobiles", ThisKey="id", OtherKey="attributes_id")]
    ...
    partial void Oncontainer_idChanged();
		...
		[Column(Storage="_container_id", DbType="Int")]
		...
		[Association(Name="bank_player", Storage="_players", ThisKey="id", OtherKey="bank_id")]
		public EntitySet<player> players
		{
			get
			{
		...
		[Association(Name="container_bank", Storage="_container", ThisKey="container_id", OtherKey="id", IsForeignKey=true, DeleteRule="CASCADE")]
    ...
    partial void Onitem_idChanged();
		...
		[Association(Name="container_bank", Storage="_banks", ThisKey="id", OtherKey="container_id")]
		...
		[Association(Name="container_container_has_item", Storage="_container_has_items", ThisKey="id", OtherKey="container_id")]
		...
		[Association(Name="container_mobile", Storage="_mobiles", ThisKey="id", OtherKey="backpack_id")]
		public EntitySet<mobile> mobiles
		{
			get
			{
		...
		[Association(Name="item_container", Storage="_item", ThisKey="item_id", OtherKey="id", IsForeignKey=true, DeleteRule="CASCADE")]
		public item item
		{
			get
			{
	...
	[Table(Name="dbo.container_has_item")]
    ...
    partial void Onitem_idChanged();
		...
		[Column(Storage="_container_id", DbType="Int NOT NULL", IsPrimaryKey=true)]
		...
		[Association(Name="container_container_has_item", Storage="_container", ThisKey="container_id", OtherKey="id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public container container
		{
			get
			{
		...
		[Association(Name="item_container_has_item", Storage="_item", ThisKey="item_id", OtherKey="id", IsForeignKey=true)]
		public item item
		{
			get
			{
    ...
    partial void OnconsumeChanged();
		...
		[Column(Storage="_resource_needed", DbType="Int")]
		...
		[Column(Storage="_crafted_item", DbType="Int")]
		...
		[Column(Storage="_consume", DbType="Bit")]
		...
		[Association(Name="itemtype_crafting", Storage="_itemtype", ThisKey="resource_needed", OtherKey="id", IsForeignKey=true, DeleteRule="CASCADE")]
		...
		[Association(Name="itemtype_crafting1", Storage="_itemtype1", ThisKey="crafted_item", OtherKey="id", IsForeignKey=true)]
    ...
    partial void OnbraceletChanged();
		...
		[Column(Storage="_head", DbType="Int")]
		...
		[Column(Storage="_chest", DbType="Int")]
		...
		[Column(Storage="_arms", DbType="Int")]
		...
		[Column(Storage="_gloves", DbType="Int")]
		...
		[Column(Storage="_legs", DbType="Int")]
		...
		[Column(Storage="_shoes", DbType="Int")]
		...
		[Column(Storage="_ring", DbType="Int")]
		...
		[Column(Storage="_lefthand", DbType="Int")]
		...
		[Column(Storage="_righthand", DbType="Int")]
		...
		[Column(Storage="_bracelet", DbType="Int")]
		...
		[Association(Name="gear_mobile", Storage="_mobiles", ThisKey="id", OtherKey="gears_id")]
		public EntitySet<mobile> mobiles
		{
			get
			{
		...
		[Association(Name="item_gear", Storage="_item", ThisKey="head", OtherKey="id", IsForeignKey=true, DeleteRule="SET NULL")]
		public item item
		{
			get
			{
		...
		[Association(Name="item_gear1", Storage="_item1", ThisKey="righthand", OtherKey="id", IsForeignKey=true)]
		public item item1
		{
			get
			{
		...
		[Association(Name="item_gear2", Storage="_item2", ThisKey="chest", OtherKey="id", IsForeignKey=true)]
		public item item2
		{
			get
			{
		...
		[Association(Name="item_gear3", Storage="_item3", ThisKey="arms", OtherKey="id", IsForeignKey=true)]
		public item item3
		{
			get
			{
		...
		[Association(Name="item_gear4", Storage="_item4", ThisKey="gloves", OtherKey="id", IsForeignKey=true)]
		public item item4
		{
			get
			{
		...
		[Association(Name="item_gear5", Storage="_item5", ThisKey="legs", OtherKey="id", IsForeignKey=true)]
		public item item5
		{
			get
			{
		...
		[Association(Name="item_gear6", Storage="_item6", ThisKey="shoes", OtherKey="id", IsForeignKey=true)]
		public item item6
		{
			get
			{
		...
		[Association(Name="item_gear7", Storage="_item7", ThisKey="ring", OtherKey="id", IsForeignKey=true)]
		public item item7
		{
			get
			{
		...
		[Association(Name="item_gear8", Storage="_item8", ThisKey="lefthand", OtherKey="id", IsForeignKey=true)]
		public item item8
		{
			get
			{
		...
		[Association(Name="item_gear9", Storage="_item9", ThisKey="bracelet", OtherKey="id", IsForeignKey=true)]
		public item item9
		{
			get
			{
    ...
    partial void OnnameChanged();
		...
		[Association(Name="guild_player", Storage="_players", ThisKey="id", OtherKey="guild_id")]
		public EntitySet<player> players
		{
			get
			{
		...
		[Association(Name="player_guild", Storage="_player", ThisKey="owner", OtherKey="id", IsForeignKey=true, DeleteRule="CASCADE")]
		public player player
		{
			get
			{
    ...
    partial void Onstyles_idChanged();
		...
		[Column(Storage="_itemtype_id", DbType="Int")]
		...
		[Column(Storage="_resistances_id", DbType="Int")]
		...
		[Column(Storage="_styles_id", DbType="Int")]
		...
		[Association(Name="item_container", Storage="_containers", ThisKey="id", OtherKey="item_id")]
		...
		[Association(Name="item_container_has_item", Storage="_container_has_items", ThisKey="id", OtherKey="item_id")]
		public EntitySet<container_has_item> container_has_items
		{
			get
			{
		...
		[Association(Name="item_gear", Storage="_gears", ThisKey="id", OtherKey="head")]
		...
		[Association(Name="item_gear1", Storage="_gears1", ThisKey="id", OtherKey="righthand")]
		...
		[Association(Name="item_gear2", Storage="_gears2", ThisKey="id", OtherKey="chest")]
		...
		[Association(Name="item_gear3", Storage="_gears3", ThisKey="id", OtherKey="arms")]
		...
		[Association(Name="item_gear4", Storage="_gears4", ThisKey="id", OtherKey="gloves")]
		...
		[Association(Name="item_gear5", Storage="_gears5", ThisKey="id", OtherKey="legs")]
		...
		[Association(Name="item_gear6", Storage="_gears6", ThisKey="id", OtherKey="shoes")]
		...
		[Association(Name="item_gear7", Storage="_gears7", ThisKey="id", OtherKey="ring")]
		...
		[Association(Name="item_gear8", Storage="_gears8", ThisKey="id", OtherKey="lefthand")]
		...
		[Association(Name="item_gear9", Storage="_gears9", ThisKey="id", OtherKey="bracelet")]
		...
		[Association(Name="itemtype_item", Storage="_itemtype", ThisKey="itemtype_id", OtherKey="id", IsForeignKey=true, DeleteRule="CASCADE")]
		public itemtype itemtype
		{
			get
			{
		...
		[Association(Name="resistance_item", Storage="_resistance", ThisKey="resistances_id", OtherKey="id", IsForeignKey=true)]
		...
		[Association(Name="style_item", Storage="_style", ThisKey="styles_id", OtherKey="id", IsForeignKey=true)]
		public style style
		{
			get
			{
    ...
    partial void Onskillreq_idChanged();
		...
		[Column(Storage="_attributereq_id", DbType="Int")]
		...
		[Column(Storage="_skillreq_id", DbType="Int")]
		...
		[Association(Name="itemtype_crafting", Storage="_craftings", ThisKey="id", OtherKey="resource_needed")]
		...
		[Association(Name="itemtype_crafting1", Storage="_craftings1", ThisKey="id", OtherKey="crafted_item")]
		...
		[Association(Name="itemtype_item", Storage="_items", ThisKey="id", OtherKey="itemtype_id")]
		...
		[Association(Name="itemtype_spellreag", Storage="_spellreags", ThisKey="id", OtherKey="itemtype_id")]
		...
		[Association(Name="attributereq_itemtype", Storage="_attributereq", ThisKey="attributereq_id", OtherKey="id", IsForeignKey=true, DeleteRule="CASCADE")]
		...
		[Association(Name="skillreq_itemtype", Storage="_skillreq", ThisKey="skillreq_id", OtherKey="id", IsForeignKey=true)]
    ...
    partial void OnnotorietyChanged();
		...
		[Column(Storage="_accesslevel", DbType="NChar(13)")]
		public string accesslevel
		{
			get
			{
		...
		[Column(Storage="_alive", DbType="Bit")]
		...
		[Column(Storage="_attributes_id", DbType="Int")]
		...
		[Column(Storage="_backpack_id", DbType="Int")]
		...
		[Column(Storage="_gears_id", DbType="Int")]
		...
		[Column(Storage="_model", DbType="SmallInt")]
		...
		[Column(Storage="_x", DbType="SmallInt")]
		...
		[Column(Storage="_y", DbType="SmallInt")]
		...
		[Column(Storage="_z", DbType="SmallInt")]
		...
		[Column(Storage="_direction", DbType="TinyInt")]
		...
		[Column(Storage="_notoriety", DbType="SmallInt")]
		...
		[Association(Name="mobile_vendor", Storage="_vendors", ThisKey="id", OtherKey="mobile_id")]
		...
		[Association(Name="mobile_monster", Storage="_monsters", ThisKey="id", OtherKey="mobile_id")]
		...
		[Association(Name="mobile_npc", Storage="_npcs", ThisKey="id", OtherKey="mobile_id")]
		...
		[Association(Name="mobile_player", Storage="_players", ThisKey="id", OtherKey="mobile_id")]
		public EntitySet<player> players
		{
			get
			{
		...
		[Association(Name="mobile_skill", Storage="_skills", ThisKey="id", OtherKey="mobile_id")]
		...
		[Association(Name="attribute_mobile", Storage="_attribute", ThisKey="attributes_id", OtherKey="id", IsForeignKey=true)]
		...
		[Association(Name="gear_mobile", Storage="_gear", ThisKey="gears_id", OtherKey="id", IsForeignKey=true)]
		public gear gear
		{
			get
			{
		...
		[Association(Name="container_mobile", Storage="_container", ThisKey="backpack_id", OtherKey="id", IsForeignKey=true)]
		public container container
		{
			get
			{
		...
		[Association(Name="resistance_mobile", Storage="_resistance", ThisKey="resistances_id", OtherKey="id", IsForeignKey=true)]
		public resistance resistance
		{
			get
			{
		...
		[Association(Name="style_mobile", Storage="_style", ThisKey="styles_id", OtherKey="id", IsForeignKey=true)]
		public style style
		{
			get
			{
    ...
    partial void Onmobile_idChanged();
		...
		[Association(Name="mobile_monster", Storage="_mobile", ThisKey="mobile_id", OtherKey="id", IsForeignKey=true)]
		public mobile mobile
		{
			get
			{
    ...
    partial void Onmobile_idChanged();
		...
		[Association(Name="mobile_npc", Storage="_mobile", ThisKey="mobile_id", OtherKey="id", IsForeignKey=true)]
		public mobile mobile
		{
			get
			{
    ...
    partial void Onguild_idChanged();
		...
		[Column(Storage="_account_id", DbType="Int")]
		...
		[Column(Storage="_bank_id", DbType="Int")]
		...
		[Column(Storage="_guild_id", DbType="Int")]
		...
		[Association(Name="player_vendor", Storage="_vendors", ThisKey="id", OtherKey="player_id")]
		public EntitySet<vendor> vendors
		{
			get
			{
		...
		[Association(Name="player_guild", Storage="_guilds", ThisKey="id", OtherKey="owner")]
		...
		[Association(Name="account_player", Storage="_account", ThisKey="account_id", OtherKey="id", IsForeignKey=true)]
		...
		[Association(Name="bank_player", Storage="_bank", ThisKey="bank_id", OtherKey="id", IsForeignKey=true)]
		public bank bank
		{
			get
			{
		...
		[Association(Name="mobile_player", Storage="_mobile", ThisKey="mobile_id", OtherKey="id", IsForeignKey=true)]
		public mobile mobile
		{
			get
			{
		...
		[Association(Name="guild_player", Storage="_guild", ThisKey="guild_id", OtherKey="id", IsForeignKey=true)]
		public guild guild
		{
			get
			{
    ...
    partial void OnidChanged();
		...
		[Association(Name="resistance_item", Storage="_items", ThisKey="id", OtherKey="resistances_id")]
		public EntitySet<item> items
		{
			get
			{
		...
		[Association(Name="resistance_mobile", Storage="_mobiles", ThisKey="id", OtherKey="resistances_id")]
		public EntitySet<mobile> mobiles
		{
			get
			{
    ...
    partial void Onmobile_idChanged();
		...
		[Column(Storage="_skilllist_id", DbType="Int")]
		...
		[Association(Name="skill_skillreq", Storage="_skillreqs", ThisKey="id", OtherKey="skill_id")]
		...
		[Association(Name="mobile_skill", Storage="_mobile", ThisKey="mobile_id", OtherKey="id", IsForeignKey=true)]
		public mobile mobile
		{
			get
			{
		...
		[Association(Name="skilllist_skill", Storage="_skilllist", ThisKey="skilllist_id", OtherKey="id", IsForeignKey=true)]
    ...
    partial void OnnameChanged();
		...
		[Association(Name="skilllist_skill", Storage="_skills", ThisKey="id", OtherKey="skilllist_id")]
		public EntitySet<skill> skills
		{
			get
			{
    ...
    partial void OnvalueChanged();
		...
		[Association(Name="skillreq_itemtype", Storage="_itemtypes", ThisKey="id", OtherKey="skillreq_id")]
		public EntitySet<itemtype> itemtypes
		{
			get
			{
		...
		[Association(Name="skillreq_spell", Storage="_spells", ThisKey="id", OtherKey="skillreq_id")]
		public EntitySet<spell> spells
		{
			get
			{
		...
		[Association(Name="skill_skillreq", Storage="_skill", ThisKey="skill_id", OtherKey="id", IsForeignKey=true)]
		public skill skill
		{
			get
			{
    ...
    partial void OnnameChanged();
		...
		[Association(Name="spell_spellreag", Storage="_spellreags", ThisKey="id", OtherKey="spell_id")]
		public EntitySet<spellreag> spellreags
		{
			get
			{
		...
		[Association(Name="skillreq_spell", Storage="_skillreq", ThisKey="skillreq_id", OtherKey="id", IsForeignKey=true)]
		public skillreq skillreq
		{
			get
			{
		...
		[Association(Name="attributereq_spell", Storage="_attributereq", ThisKey="attributereq_id", OtherKey="id", IsForeignKey=true)]
		public attributereq attributereq
		{
			get
			{
    ...
    partial void Onspell_idChanged();
		...
		[Column(Storage="_quantity", DbType="NVarChar(45)")]
		...
		[Column(Storage="_spell_id", DbType="Int")]
		...
		[Association(Name="itemtype_spellreag", Storage="_itemtype", ThisKey="itemtype_id", OtherKey="id", IsForeignKey=true)]
		public itemtype itemtype
		{
			get
			{
		...
		[Association(Name="spell_spellreag", Storage="_spell", ThisKey="spell_id", OtherKey="id", IsForeignKey=true)]
		public spell spell
		{
			get
			{
    ...
    partial void OnidChanged();
		...
		[Association(Name="style_item", Storage="_items", ThisKey="id", OtherKey="styles_id")]
		public EntitySet<item> items
		{
			get
			{
		...
		[Association(Name="style_mobile", Storage="_mobiles", ThisKey="id", OtherKey="styles_id")]
		public EntitySet<mobile> mobiles
		{
			get
			{
